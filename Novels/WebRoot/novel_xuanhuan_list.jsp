...
<%@ page import="novel_fenlei.xuanhuannovelbean"%>
...
<div id="nav">
    <nav>
       ...
       <div id="d1">
        <ul>
            <li><a href="servlet/xuanhuanServlet">玄幻</a></li>
            <li><a href="#">悬疑</a></li>
            <li><a href="#">灵异</a></li>
            <li><a href="#">都市</a></li>
            <li><a href="#">动漫</a></li>
    ...
    <div id="d2">
    	<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="white">
    		<%
    			List<xuanhuannovelbean> list=(List<xuanhuannovelbean>) request.getAttribute("list");
    			if(list==null || list.size()<1){
    				out.print("没有任何信息!");
    			}else{
    				for(xuanhuannovelbean xuanhuan:list){
    		%>
 			<tr aglin="center">
 				<td><img src="<%=xuanhuan.getNovelimg() %>"></td>
 			</tr>
 			<%
 				}
 				}
